"""
Django settings for payment_money_44814 project.
...
ROOT_URLCONF = 'payment_money_44814.urls'
...
WSGI_APPLICATION = 'payment_money_44814.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "payment_money_44814 API",
    "DESCRIPTION": "API documentation for payment_money_44814 App",
    "VERSION": "v1",
}
